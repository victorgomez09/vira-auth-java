...
public class PageController {
    ...
    public ResponseEntity<PageDto> createPage(@RequestBody @Valid PageDto requestDto,
        ...
        return ResponseEntity.ok(mapper.toDto(service.createPage(mapper.toEntity(requestDto),
                userId)));
    }
    ...
    public ResponseEntity<PageDto> updatePage(@RequestBody @Valid PageDto requestDto,
            @Parameter(hidden = true) @RequestHeader("X-User-Id") String userId,
            BindingResult result) {
        return ResponseEntity.ok(mapper.toDto(service.updatePage(mapper.toEntity(requestDto),
                userId)));
    }
