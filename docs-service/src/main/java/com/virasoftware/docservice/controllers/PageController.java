...
// @Operation(summary = "Get all pages from space", description = "Get all pages
// from space")
// @GetMapping
// @ValidateErrors
// public ResponseEntity<List<PageDto>>
// findAllPagesBySpace(@RequestHeader("X-User-Id") String userId,
...
// @Operation(summary = "Get page by id", description = "Get all pages from
// space")
// @GetMapping("/{pageId}")
// @ValidateErrors
// public ResponseEntity<PageDto> findPageById(@RequestHeader("X-User-Id")
// String userId,
...
// @PostMapping
// @ValidateErrors
// public ResponseEntity<PageDto> createPage(@RequestBody @Valid PageDto
// requestDto,
// @Parameter(hidden = true) @RequestHeader("X-User-Id") String userId,
// BindingResult result) {
// return
// ResponseEntity.ok(mapper.toDto(service.createPage(mapper.toEntity(requestDto),
// userId)));
// }
...
// @PutMapping
// @ValidateErrors
// public ResponseEntity<PageDto> updatePage(@RequestBody @Valid PageDto
// requestDto,
// @Parameter(hidden = true) @RequestHeader("X-User-Id") String userId,
// BindingResult result) {
// return
// ResponseEntity.ok(mapper.toDto(service.updatePage(mapper.toEntity(requestDto),
// userId)));
// }
...
// @DeleteMapping
// @ValidateErrors
// public ResponseEntity<Void> deletePage(@PathVariable("page") @Valid String
// pageId,
// @Parameter(hidden = true) @RequestHeader("X-User-Id") String userId,
// BindingResult result) {
